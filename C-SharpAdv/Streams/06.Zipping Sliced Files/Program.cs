...
namespace _06.Zipping_Sliced_Files
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			string sourceFilePath = @"D:\CSharpAdvance\C-SharpAdvanced\Streams\06.Zipping Sliced Files\sliceMe.mp4";
			string destinationDirectory = @"D:\CSharpAdvance\C-SharpAdvanced\Streams\06.Zipping Sliced Files\";
