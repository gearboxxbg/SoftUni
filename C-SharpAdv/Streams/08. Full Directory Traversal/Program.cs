...
namespace _08._Full_DIrectory_Travelser
{
	public class FullDirectoryTraversal
	{
		public static void Main()
		{
			...
			using (var writeStream = new FileStream(@"C:\Users\Gearboxx\Desktop\repository\SoftUni\C-SharpAdv\Streams\08. Full Directory Traversal\report.txt", FileMode.Create))
			{
